 ...
 */
// NOTE THE BACKTICK KEY IS IMPORTANT FOR TEMPLATES EXAMPLE HERE contactsTemplate += ```
function drawContacts() {
  ...
  contacts.forEach((contact) => {
    ...
    <div class='contact-card ${
      ...
      <p><i class="fa fa-phone-square fa-lg" aria-hidden="true"></i>  ${
        contact.phone
      }</p>
      <button type="button" onclick=" removeContact('${
        contact.id
      }')"><i class="fa fa-user-times fa-lg" aria-hidden="true"></i></button>
    </div>
    `;
  });
